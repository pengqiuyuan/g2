...
import com.g2.service.count.TasksService;
...
@RequestMapping(value="/manage/game/tasks")
public class TasksController extends BaseController{
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		TasksController.sortTypes = sortTypes;
	}
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = tasksService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", tasksService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", tasksService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/tasks/index";
	}
