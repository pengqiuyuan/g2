...
@RequestMapping(value="/manage/game/dataRank")
public class DataRankController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(DataRankController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		DataRankController.sortTypes = sortTypes;
	}
