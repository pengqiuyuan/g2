...
import com.g2.service.count.LevelDistributeService;
 ...
 *
 */
@Controller("levelDistributeController")
@RequestMapping(value="/manage/game/levelDistribute")
public class LevelDistributeController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(LevelDistributeController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		LevelDistributeController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private LevelDistributeService levelDistributeService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = levelDistributeService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", levelDistributeService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", levelDistributeService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/level/distribute/index";
	}
