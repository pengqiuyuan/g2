...
import com.g2.service.count.PlayerRetentionService;
 ...
 *
 */
@Controller("playerRetentionController")
@RequestMapping(value="/manage/game/playerRetention")
public class PlayerRetentionController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(PlayerRetentionController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		PlayerRetentionController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private PlayerRetentionService playerRetentionService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = playerRetentionService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", playerRetentionService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", playerRetentionService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/player/retention/index";
	}
