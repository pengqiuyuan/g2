...
import com.g2.service.count.VirtualEconomyVirtualCoinService;
 ...
 *
 */
@Controller("virtualEconomyVirtualCoinController")
@RequestMapping(value="/manage/game/virtualEconomyVirtualCoin")
public class VirtualEconomyVirtualCoinController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(VirtualEconomyVirtualCoinController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		VirtualEconomyVirtualCoinController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private VirtualEconomyVirtualCoinService virtualEconomyVirtualCoinService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = virtualEconomyVirtualCoinService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", virtualEconomyVirtualCoinService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", virtualEconomyVirtualCoinService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/virtualeconomy/virtualcoin/index";
	}
