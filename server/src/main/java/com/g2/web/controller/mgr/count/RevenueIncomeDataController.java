...
import com.g2.service.count.RevenueIncomeDataService;
 ...
 *
 */
@Controller("revenueIncomeDataController")
@RequestMapping(value="/manage/game/revenueIncomeData")
public class RevenueIncomeDataController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(RevenueIncomeDataController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		RevenueIncomeDataController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private RevenueIncomeDataService revenueIncomeDataService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = revenueIncomeDataService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", revenueIncomeDataService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", revenueIncomeDataService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/revenue/incomedata/index";
	}
