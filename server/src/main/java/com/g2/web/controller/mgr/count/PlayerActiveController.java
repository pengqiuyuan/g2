...
import com.g2.service.count.PlayerActiveService;
 ...
 *
 */
@Controller("playerActiveController")
@RequestMapping(value="/manage/game/playerActive")
public class PlayerActiveController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(PlayerActiveController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		PlayerActiveController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private PlayerActiveService playerActiveService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = playerActiveService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", playerActiveService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", playerActiveService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/player/active/index";
	}
