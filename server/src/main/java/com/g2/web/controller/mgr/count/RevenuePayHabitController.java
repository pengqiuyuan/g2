...
import com.g2.service.count.RevenuePayHabitService;
 ...
 *
 */
@Controller("revenuePayHabitController")
@RequestMapping(value="/manage/game/revenuePayHabit")
public class RevenuePayHabitController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(RevenuePayHabitController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		RevenuePayHabitController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private RevenuePayHabitService revenuePayHabitService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		model.addAttribute("dateFrom", revenuePayHabitService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", revenuePayHabitService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/revenue/payhabit/index";
	}
