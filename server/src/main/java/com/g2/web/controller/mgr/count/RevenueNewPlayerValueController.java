...
import com.g2.service.count.RevenueNewPlayerValueService;
 ...
 *
 */
@Controller("revenueNewPlayerValueController")
@RequestMapping(value="/manage/game/revenueNewPlayerValue")
public class RevenueNewPlayerValueController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(RevenueNewPlayerValueController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		RevenueNewPlayerValueController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private RevenueNewPlayerValueService revenueNewPlayerValueService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = revenueNewPlayerValueService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", revenueNewPlayerValueService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", revenueNewPlayerValueService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/revenue/newplayervalue/index";
	}
