...
import com.g2.service.count.PlayerConvertionService;
 ...
 *
 */
@Controller("playerConvertionController")
@RequestMapping(value="/manage/game/playerConvertion")
public class PlayerConvertionController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(PlayerConvertionController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		PlayerConvertionController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private PlayerConvertionService playerConvertionService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = playerConvertionService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", playerConvertionService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", playerConvertionService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/player/convertion/index";
	}
