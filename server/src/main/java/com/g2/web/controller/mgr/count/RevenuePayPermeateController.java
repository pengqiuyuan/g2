...
import com.g2.service.count.RevenuePayPermeateService;
 ...
 *
 */
@Controller("revenuePayPermeateController")
@RequestMapping(value="/manage/game/revenuePayPermeate")
public class RevenuePayPermeateController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(RevenuePayPermeateController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		RevenuePayPermeateController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private RevenuePayPermeateService revenuePayPermeateService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = revenuePayPermeateService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", revenuePayPermeateService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", revenuePayPermeateService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/revenue/paypermeate/index";
	}
