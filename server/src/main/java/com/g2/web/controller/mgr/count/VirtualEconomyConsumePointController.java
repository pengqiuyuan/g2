...
import com.g2.service.count.VirtualEconomyConsumePointService;
 ...
 *
 */
@Controller("virtualEconomyConsumePointController")
@RequestMapping(value="/manage/game/virtualEconomyConsumePoint")
public class VirtualEconomyConsumePointController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(VirtualEconomyConsumePointController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		VirtualEconomyConsumePointController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private VirtualEconomyConsumePointService virtualEconomyConsumePointService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = virtualEconomyConsumePointService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", virtualEconomyConsumePointService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", virtualEconomyConsumePointService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/virtualeconomy/consumepoint/index";
	}
