...
import com.g2.service.count.VirtualEconomyConsumeAnalysisService;
 ...
 *
 */
@Controller("virtualEconomyConsumeAnalysisController")
@RequestMapping(value="/manage/game/virtualEconomyConsumeAnalysis")
public class VirtualEconomyConsumeAnalysisController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(VirtualEconomyConsumeAnalysisController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		VirtualEconomyConsumeAnalysisController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private VirtualEconomyConsumeAnalysisService virtualEconomyConsumeAnalysisService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = virtualEconomyConsumeAnalysisService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", virtualEconomyConsumeAnalysisService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", virtualEconomyConsumeAnalysisService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/virtualeconomy/consumeanalysis/index";
	}
