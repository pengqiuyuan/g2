...
import com.g2.service.count.LevelScheduleService;
 ...
 *
 */
@Controller("levelScheduleController")
@RequestMapping(value="/manage/game/levelSchedule")
public class LevelScheduleController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(LevelScheduleController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		LevelScheduleController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private LevelScheduleService levelScheduleService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = levelScheduleService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", levelScheduleService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", levelScheduleService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/level/schedule/index";
	}
