...
import com.g2.service.count.ConcurrentService;
...
@RequestMapping(value="/manage/game/concurrent")
public class ConcurrentController extends BaseController{
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		ConcurrentController.sortTypes = sortTypes;
	}
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = concurrentService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", concurrentService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", concurrentService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/concurrent/index";
	}
