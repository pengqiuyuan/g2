...
import com.g2.service.count.PlayerChurnedService;
 ...
 *
 */
@Controller("playerChurnedController")
@RequestMapping(value="/manage/game/playerChurned")
public class PlayerChurnedController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(PlayerChurnedController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		PlayerChurnedController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private PlayerChurnedService playerChurnedService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = playerChurnedService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", playerChurnedService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", playerChurnedService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/player/churned/index";
	}
