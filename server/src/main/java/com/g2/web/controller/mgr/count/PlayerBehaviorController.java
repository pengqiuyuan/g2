...
import com.g2.service.count.PlayerBehaviorService;
 ...
 *
 */
@Controller("playerBehaviorController")
@RequestMapping(value="/manage/game/playerBehavior")
public class PlayerBehaviorController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(PlayerBehaviorController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		PlayerBehaviorController.sortTypes = sortTypes;
	}
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = playerBehaviorService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", playerBehaviorService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", playerBehaviorService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/player/behavior/index";
	}
