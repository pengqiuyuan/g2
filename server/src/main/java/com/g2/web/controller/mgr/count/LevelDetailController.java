...
@RequestMapping(value="/manage/game/levelDetail")
public class LevelDetailController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(LevelDetailController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		LevelDetailController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private LevelDetailService levelDetailService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = levelDetailService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", levelDetailService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", levelDetailService.nowDate());
