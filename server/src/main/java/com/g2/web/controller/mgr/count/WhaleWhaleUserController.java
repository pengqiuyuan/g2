...
import com.g2.service.count.WhaleWhaleUserService;
 ...
 *
 */
@Controller("whaleWhaleUserController")
@RequestMapping(value="/manage/game/whaleWhaleUser")
public class WhaleWhaleUserController extends BaseController{

	private static final Logger logger = LoggerFactory.getLogger(WhaleWhaleUserController.class);
	...
	public static void setSortTypes(Map<String, String> sortTypes) {
		WhaleWhaleUserController.sortTypes = sortTypes;
	}
	...
	@Autowired
	private WhaleWhaleUserService whaleWhaleUserService;
	...
	public String index(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Long userId = whaleWhaleUserService.getCurrentUserId();
		...
		model.addAttribute("dateFrom", whaleWhaleUserService.thirtyDayAgoFrom());
		model.addAttribute("dateTo", whaleWhaleUserService.nowDate());
		
		// 将搜索条件编码成字符串，用于排序，分页的URL
		model.addAttribute("searchParams", Servlets.encodeParameterStringWithPrefix(searchParams, "search_"));
		return "/game/whalewhaleuser/index";
	}
