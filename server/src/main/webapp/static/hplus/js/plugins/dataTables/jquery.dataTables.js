...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var jqFilter = $('input[type="search"]', filter)
			...
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/keyup.DT search.DT input.DT paste.DT cut.DT*/, function(e) {
			...
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/keypress.DT*/, function(e) {
		...
		$(settings.nTable).on( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/filter.DT*/, function () {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		select
			...
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/change.DT*/, function(e) {
	...
	{
		$(n)
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/click.DT*/, oData, function (e) {
					n.blur(); // Remove focus outline for mouse users
					fn(e);
				} )
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/keypress.DT*/, oData, function (e){
				if ( e.which === 13 ) {
					fn(e);
				} } )
			.bind( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/selectstart.DT*/, function () {
	...
	DataTable.defaults = {
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": "../../../../../error/ie.html"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/data.json*/
		 *   } );
		 *
		 * @example
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": {
		 *       "url": "../../../../../error/ie.html"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/data.json*/,
		 *       "dataSrc": "tableData"
		 *     }
		 *   } );
		 *
		 ...
		 *           json[i][0] = '<a href="http://www.zi-han.net/message/%27+json[i][0]+%27>View message</a>%27; *         } *         return json; *       } *     } *   } ); * * @example *   // Add data to the request *   $(%27#example%27).dataTable( { *"ajax": {
		 *       "url": "../../../../../error/ie.html"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/data.json*/,
		 *       "data": function ( d ) {
		 *         return {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajax": "../../../../../error/ie.html"/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/sources/arrays.txt*/,
		 *        "deferRender": true
		 *      } );
		 *    } );
		 */
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, idx, classes ) {
				...
				$(settings.nTable).on( '../../../../../error/ie.html'/*tpa=http://www.zi-han.net/theme/hplus/js/plugins/dataTables/order.dt*/, function ( e, settings, sorting, columns ) {
					cell
						.removeClass(
