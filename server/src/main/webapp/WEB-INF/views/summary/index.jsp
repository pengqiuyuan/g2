...
<body>
			...
			<form id="inputForm" method="post" Class="form-horizontal" action="#" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<label class="checkbox inline"> <input type="checkbox" id="inlineCheckbox3" value="option3"> 运营大区3 </label>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<label class="checkbox inline"> <input type="checkbox" id="inlineCheckbox3" value="option3"> 渠道3 </label>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<label class="checkbox inline"> <input type="checkbox" id="inlineCheckbox3" value="option3"> 服务器3 </label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"></label>
	...
	<script type="text/javascript">
			...
			chart.point().position('GDP*LifeExpectancy').size('Population', 35,
