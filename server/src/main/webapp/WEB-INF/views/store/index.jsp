...
<body>
	...
	<div >
		...
		<div style="height: 30px;color: red;font-family: 14px"><span>提示：拖拽可改变门店排序</span></div>
				...
				<c:forEach items="${stores.content}" var="item" varStatus="s">
					...
					<tr id="${item.id}" value="${item.sort}" >
						...
						<a
							...
							data-fancybox-type="iframe" rel="fancy" title="门店详细" class="showInfo" >${item.name }</a>
						</td>
