			...
			<div class="controls">
				<select id="province" name="province"  class="province-select">
					...
					<c:forEach items = "${province}" var="pro">
						<option ${store.province==pro.id ? 'selected':'' } value="${pro.id}">${pro.name}</option>
					</c:forEach>
				</select>
			</div>
		</div>
...
<div
	...
	<div class="controls">
		<input type="text" name="longitude" value="${store.longitude }"   class="input-large"  />
	</div>
</div><div
	class="control-group">
	<label class="control-label" for="latitude">纬度：</label>
	<div class="controls">
		<input type="text" name="latitude" value="${store.latitude }"   class="input-large"  />
	</div>
</div><div
	class="control-group">
...
<div
	...
	<div class="controls">
		<input type="text" name="partner" value="${store.partner }"   class="input-large"  />
	</div>
</div>
<div
	class="control-group">
	...
	<div class="controls">
		<input type="text" name="seller" value="${store.seller }"   class="input-large"  />
	</div>
</div>
<div
	class="control-group">
	...
	<div class="controls">
				<textarea rows="5"  name="privateKey " style="width: 400px" >${store.privateKey }</textarea>
