...
<div
	...
	<div class="controls">
		...
		<shiro:hasRole name="admin">
		    <option value="admin" ${ user.roles == 'admin' ? 'selected' : ''}>总店管理员</option>
			<option value="business"  ${ user.roles == 'business' ? 'selected' : ''} >总店业务员</option>
		</shiro:hasRole>	
		    <option value="store_admin"  ${ user.roles == 'store_admin' ? 'selected' : ''} >分店管理员</option>
			<option value="store_business"  ${ user.roles == 'store_business' ? 'selected' : ''} >分店业务员</option>
		</select>
	</div>
</div>
