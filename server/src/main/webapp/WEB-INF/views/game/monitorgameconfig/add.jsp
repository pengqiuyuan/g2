...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/manage/game/monitorGameConfig/save" enctype="multipart/form-data">
		<div class="control-group">
			<label class="control-label" for="configKey">配置项：</label>
			<div class="controls">
				<input type="text" name="configKey" class="input-large " />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="configValue">配置值：</label>
			<div class="controls">
				<input type="text" name="configValue" class="input-large "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="nodes">作用备注：</label>
			<div class="controls">
				<input type="text" name="nodes" class="input-large " />
			</div>
		</div>
